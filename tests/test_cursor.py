...
class SparseCursorTests(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.messages = [
            self.events.send(
                "alice", "bob", "slipway", character.lower() * 40,
    ...
    def test_presented_acknowledgment_remains_valid_history_after_later_retraction(self) -> None:
        ...
        self.events.retract(
            ...
            reason="sent_in_error", author="alice",
        )
