...
READER_ASSIGNMENTS = (
    ...
    ("floati/events.py", "EventLog.unacked_ids", "SparseCursor", 1, "sparse_inbox_ack_cursor"),
    ("floati/events.py", "EventLog.unacked_ids", "SparseCursor(self.root).acked_ids", 1, "sparse_inbox_ack_cursor"),
