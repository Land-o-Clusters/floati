...
|---|---|---:|---|---|
| **claude / cli** (control) | `~/.claude/projects/-Users-penguinspecz-Projects-floati-grok/*.jsonl` | 11 | `message.usage.input_tokens`, `output_tokens`, `cache_read_input_tokens`, `cache_creation_input_tokens`, … | **stands as class A** (matches the amendment; this seat reproduces the nest) |
