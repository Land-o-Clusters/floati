...
```text
PYTHONPYCACHEPREFIX=/private/tmp/puddle-lane-d4d5-pycache python3 -m py_compile floati/node_explain.py floati/state_receipts.py tests/test_node_explain.py tests/test_state_receipts.py
git diff --check
```
