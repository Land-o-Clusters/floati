# WS-I SPEC — THE AGENT SURFACE: humans and agents as first-class operators (Fable, 2026-08-28)
...
management — and advertised as such. **The design authority is dogfood: an agent (Fable) operated
...
- **I1 — public `AGENTS.md`** *(Fable authors; the current root AGENTS.md is fleet-internal and
