...
The `tenant-a` example uses the durable home `/var<temp>/floati-tenant-a`.
...
```sh
/repo/floati/scripts/floati init --root /var<temp>/floati-tenant-a
```
...
/repo/floati/scripts/floati register --root /var<temp>/floati-tenant-a reviewer --harness Claude

# Run by builder-app from its Codex harness.
/repo/floati/scripts/floati register --root /var<temp>/floati-tenant-a builder-app --harness Codex

# Run by builder-floati from its Codex harness.
/repo/floati/scripts/floati register --root /var<temp>/floati-tenant-a builder-floati --harness Codex
```
...
```sh
/repo/floati/scripts/floati inbox --root /var<temp>/floati-tenant-a --as reviewer
/repo/floati/scripts/floati inbox --root /var<temp>/floati-tenant-a --as builder-app
/repo/floati/scripts/floati inbox --root /var<temp>/floati-tenant-a --as builder-floati
```
...
```sh
/repo/floati/scripts/floati ack --root /var<temp>/floati-tenant-a --as reviewer --id <message-id>
```
...
```sh
/repo/floati/scripts/floati send --root /var<temp>/floati-tenant-a --from builder-floati --to reviewer --repo floati --sha <checkpoint-sha> --doc docs/evidence/checkpoint.md --note checkpoint
/repo/floati/scripts/floati log --root /var<temp>/floati-tenant-a
```
