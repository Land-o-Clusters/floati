"""Cursor Agent worker adapter — roster 2 of the full-parity roster.
...
_DEFAULT_COMMAND = ('/opt/homebrew/bin/cursor-agent',)
...
class CursorAgentAdapter(HeadlessProfileAdapter):
    """Cursor Agent worker with explicit workspace and fail-closed tools."""
