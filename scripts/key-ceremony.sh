...
echo "        minisign -S -s <backup-copy> -x /tmp/t.minisig -t restore-test -m /tmp/t"
echo "      (create /tmp/t with any content first; a backup that never restored is not a backup)"
